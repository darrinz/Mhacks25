PROMPTS = {
    ...
    "email_filterizer": {
        ...
        "goal": (
            ...
            "5.  **Compile Details:** For each meeting topic, create a concise summary that includes all related points, questions, and perspectives. List the NAMES of all participants who contributed to the topic, not just participant number.\n"
    ...
    "agendaizer": {
        ...
        "goal": (
            ...
            "4. Below the heading, add a line for `**Contributors:**` and list the names from the `submitted_by` array.\n"
